...
- **Zustand / Jotai / Redux** — внешние хранилища состояния, доступные из любого компонента.
...
- **Zustand** — минималистичное хранилище на основе хуков; без бойлерплейта; самый популярный легковесный вариант.
- **Jotai** — атомарная модель состояния, вдохновлённая Recoil.
- **TanStack Query (React Query)** — управление состоянием сервера; кэширование, фоновое обновление, оптимистичные обновления.
