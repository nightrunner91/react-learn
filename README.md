...
> Раздел реструктуризируется: новые статьи появляются по мере готовности. Легаси-версия всего материала в одном файле: [JavaScript Core — глубокое понимание](./docs/javascript/js-core.md).
