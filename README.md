...
7. [React 19 и новее — новые возможности](#react-19-и-новее--новые-возможности)
8. [Серверные компоненты и серверные действия](#серверные-компоненты-и-серверные-действия)
9. [Конкурентный React](#конкурентный-react)
10. [Redux и современные инструменты управления состоянием](#redux-и-современные-инструменты-управления-состоянием)
11. [React Router v7](#react-router-v7)
12. [Context API](#context-api)
13. [Обработка ошибок](#обработка-ошибок)
14. [Стилизация компонентов в React](#стилизация-компонентов-в-react)
15. [Порталы](#порталы)
16. [Тестирование в React](#тестирование-в-react)
17. [Оптимизация производительности](#оптимизация-производительности)
18. [Серверный рендеринг и потоковая передача](#серверный-рендеринг-и-потоковая-передача)
