...
[Типы данных и приведение типов](./docs/javascript/js-data-types.md)
...
[Коллекции, итераторы, генераторы](./docs/javascript/js-collections-iterators.md)
...
[Proxy и Reflect](./docs/javascript/js-proxy-reflect.md)
...
[Функциональное программирование](./docs/javascript/js-functional.md)
...
[Память и производительность](./docs/javascript/js-memory.md)

> Легаси-версия всего раздела в одном файле пока доступна как [JavaScript Core — глубокое понимание](./docs/javascript/js-core.md), но в дальнейшем она будет заменена новыми статьями.
